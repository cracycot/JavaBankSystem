...
public class MainBank {
    ...
    public void interbankTransfer(String bankFirstName, String bankSecondName, int idFirstAccount, int idSecondAccount, float amount) throws InsufficientFundsException {
